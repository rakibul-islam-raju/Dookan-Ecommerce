...
PRODUCTS = [
    ...
    },
    {
        ...
        "compare_at_price": Decimal("260.00"),
        "stock_quantity": 80,
        "unit": "kg",
        "unit_value": Decimal("1"),
        "is_featured": True,
    ...
    # Nuts & Dry Fruits
    {
        ...
        "compare_at_price": Decimal("850.00"),
        "stock_quantity": 50,
        "unit": "g",
        "unit_value": Decimal("500"),
        "is_featured": True,
...
PRODUCT_VARIANTS = [
    {
        ...
        "variant_type": "Weight",
        "variants": [
            {"option": "250g", "sku": "HON-001-250", "price": Decimal("200.00"), "stock": 30},
            {"option": "500g", "sku": "HON-001-500", "price": Decimal("380.00"), "stock": 40},
            {"option": "1kg", "sku": "HON-001-1K", "price": Decimal("650.00"), "stock": 50},
        ],
    },
    {
        "product_sku": "GHE-001",
        "variant_type": "Weight",
        "variants": [
            {"option": "250g", "sku": "GHE-001-250", "price": Decimal("250.00"), "stock": 30},
            {"option": "500g", "sku": "GHE-001-500", "price": Decimal("480.00"), "stock": 35},
            {"option": "1kg", "sku": "GHE-001-1K", "price": Decimal("850.00"), "stock": 40},
        ],
    },
    {
        "product_sku": "NUT-003",
        "variant_type": "Size",
        "variants": [
            {"option": "Small", "sku": "NUT-003-SM", "price": Decimal("500.00"), "stock": 25},
            {"option": "Medium", "sku": "NUT-003-MD", "price": Decimal("950.00"), "stock": 30},
            {"option": "Large", "sku": "NUT-003-LG", "price": Decimal("1750.00"), "stock": 15},
        ],
    },
]
